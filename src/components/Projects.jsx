        ...
        <div className="mb-14">
          ...
          <div className="flex flex-col md:flex-row md:items-end md:justify-between mt-4">
            <motion.h2
              ...
              className="font-serif text-navy text-4xl md:text-5xl font-bold"
            >
              Featured Projects
            </motion.h2>
            <motion.p
          ...
          {projects.map((project, i) => (
            ...
            >
              ...
              <div className="absolute inset-0 flex flex-col justify-end p-6">
                ...
                <p className="text-cream/0 group-hover:text-cream/70 text-sm leading-relaxed transition-all duration-500 max-h-0 group-hover:max-h-20 overflow-hidden">
                  {project.description}
                </p>
              </div>
